...
NSString * const ID = @"TGRotationViewCell";

@interface TGRotationView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)initialization
{
    _pageControlAliment = TGRotationViewPageContolAlimentCenter;
    ...
    _pageControlStyle = TGRotationViewPageContolStyleClassic;
...
{
    TGRotationView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[TGRotationViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setDelegate:(id<TGRotationViewDelegate>)delegate
{
    _delegate = delegate;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.pageControlStyle != TGRotationViewPageContolStyleAnimated) {
        self.pageControlStyle = TGRotationViewPageContolStyleAnimated;
    }
...
- (void)setPageControlStyle:(TGRotationViewPageContolStyle)pageControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case TGRotationViewPageContolStyleAnimated:
        {
        ...
        case TGRotationViewPageContolStyleClassic:
        {
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == TGRotationViewPageContolAlimentRight) {
...
{
    TGRotationViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
